...
const quizData = [
    ...
    { genre: "A", q: "スイッチを入れるとLEDが光りますが、このときロボットはどのような状態ですか？", a: ["電池が切れた", "故障している", "モータが動く準備ができた"], correct: 2, ex: "スイッチを入れるとLEDが光り、モータが動く準備ができたことを知らせます。" },
    
    // ジャンルB
    { genre: "B", q: "はんだ付けを始めるとき、部品の足とランドを、はんだごてで同時に温める時間は、およそ何秒間くらいですか？", a: ["1秒間", "3秒間", "10秒間"], correct: 1, ex: "はんだごてで部品の足とランド（基板の穴の周り)を同時に3秒間くらい温めます。" },
    { genre: "B", q: "正しくはんだ付けができたとき、溶けたはんだがどのような形になっていれば「OK」ですか？", a: ["丸い形", "平らな形", "山の形"], correct: 2, ex: "はんだが山の形になればOKです。" },
    { genre: "B", q: "はんだが溶けて濡れたような状態になったら、はんだごてとはんだのどちらを先に離すのが正しい手順ですか？", a: ["はんだを離してからはんだごてを離す", "はんだごてを離しからはんだを離す", "同時に離す"], correct: 0, ex: "はんだが全体に流れ、濡れたような状態になったら、まずはんだを離し、最後にはんだごてを離します。" },
    { genre: "B", q: "はんだ付けをする前に、部品が基板から抜け落ちないように足を広げますが、どんな形で広げますか？", a: ["ハの字", "八の字", "くの字"], correct: 1, ex: "部品の足を八の字に広げます。" },
    { genre: "B", q: "はんだ付けが終わった後、部品の余分な足をニッパーで切りますが、そのときに守るべき注意点は何ですか？", a: ["足を持ちながら切る", "一気に素早く切る", "根元を切る"], correct: 0, ex: "部品の足を切るときは、足を持ちながら切ります。" },

    // ジャンルC
    { genre: "C", q: "この光源追跡マイクロロボットの電気回路で使う「抵抗」の部品は全部でいくつありますか？", a: ["1つ", "2つ", "3つ"], correct: 2, ex: "抵抗は抵抗1、抵抗2、抵抗3の合計3つです。" },
    { genre: "C", q: "LEDやトランジスタを取り付けるとき、長い足と短い足がある場合、短い足は基板の穴のどの形に入れますか？", a: ["丸い穴", "四角い穴", "三角の穴"], correct: 1, ex: "短い足を四角い穴に、長い足を丸い穴に取り付けます。" },
    { genre: "C", q: "基板の「R3」と書かれた場所に取り付ける抵抗は、どちらの抵抗値のものを使いますか？", a: ["10kΩ", "75Ω", "1kΩ"], correct: 1, ex: "R3に75Ωを取り付けます（R1・R2には10kΩを取り付けます）。" },
    { genre: "C", q: "電池を使う時の注意点として、電池の向きについて特にしてはいけないことは何ですか？", a: ["電池を逆向きに入れる", "電池を並べて置く", "電池にテープを貼る"], correct: 0, ex: "電池は逆向きに入れないでください。" },
    { genre: "C", q: "このロボットが光を感じ取るための、顔のように前方に突き出すように取り付ける部品の名前は何ですか？", a: ["フォトダイオード", "フォトトランジスタ", "フォトセンサー"], correct: 1, ex: "ロボットが光を感じ取るための部品は、フォトトランジスタと言います。" },
    ...
    // ジャンルD
    { genre: "D", q: "車輪を取り付けた後、組み立てが正しくできたかどうか確認するテスト方法は何ですか？", a: ["水平な机の上に置く", "車体を振ってみる", "手で少し引っ張る"], correct: 1, ex: "車体を振ってみて、車輪が外れなければ取り付け完了です。" },
    ...
    { genre: "D", q: "電池の電気がなくなってしまった場合、説明書にはその電池を何ゴミとして捨てるようにしますか？", a: ["燃えるゴミ", "資源ゴミ", "燃えないゴミ"], correct: 2, ex: "電池がなくなったら、燃えないゴミとして捨ててください。" },
    { genre: "D", q: "モーターを後ろの車体パーツに取り付けるとき、配線をどのようにする必要がありますか？", a: ["配線を交差させながら", "配線をまっすぐ伸ばして", "配線が触れないように"], correct: 0, ex: "モーターを配線を交差させながら、後ろの車体パーツに取り付けます。" },
